...
$CXX $CXXFLAGS -c -I fuzzlpm/ -I $SRC/LPM/external.protobuf/include fuzzlpm/cel-go-lpm.cc
...
$SRC/LPM/external.protobuf/bin/protoc --go_out=fuzzlpm/ $SRC/cel-go-lpm.proto
