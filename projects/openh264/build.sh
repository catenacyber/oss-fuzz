...
$CXX $CXXFLAGS -o $OUT/encoder_fuzzer -I./codec/api/wels -I./codec/console/common/inc -I./codec/common/inc -L. $LIB_FUZZING_ENGINE $SRC/encoder_fuzzer.cpp libopenh264.a
